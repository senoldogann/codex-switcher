...
struct AnalyticsWindowView: View {
    ...
    private var limitPressureSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            sectionHeader(
                ...
                subtitle: L("Hesap bazlı risk ve veri güveni", "Per-account risk and data confidence")
            )
    ...
    private var alertConfidenceLabel: String {
        ...
        case .high: return L("Yüksek güven", "High confidence")
        case .degraded: return L("Azalan güven", "Degraded confidence")
        case .low: return L("Düşük güven", "Low confidence")
        }
    }
